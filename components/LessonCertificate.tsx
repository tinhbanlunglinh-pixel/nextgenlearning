        ...
        >
          ...
          <div className="relative h-full flex flex-col items-center justify-between px-12 py-10" style={{ margin: '24px' }}>
            ...
            <div className="text-center">
              ...
              <p className="text-xs font-bold text-brand-600 uppercase tracking-[0.25em] mb-1">Trung tâm Ngoại Ngữ English NEXTGEN ENGLISH</p>
            ...
            <div className="w-full flex justify-between items-end px-4">
              <div className="text-left">
                ...
                <p className="text-sm font-bold text-brand-600 mt-1">Learn English, Lead the way 💚</p>
              </div>
              <div className="text-right">
                ...
                <p className="text-[10px] text-slate-400">Trung tâm Ngoại Ngữ English NEXTGEN ENGLISH</p>
              </div>
            </div>
          </div>
        </div>
