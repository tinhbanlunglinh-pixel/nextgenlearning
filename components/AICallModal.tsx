    ...
    try {
      ...
      const sessionPromise = ai.live.connect({
        ...
        config: {
          ...
          systemInstruction: `You are NEXTGEN ENGLISH, a polyglot English teacher at "ENGLISH NEXTGEN ENGLISH". 
      ...
      <div className="bg-white rounded-[3.5rem] p-10 md:p-14 max-w-lg w-full relative overflow-hidden shadow-2xl border-[12px] border-brand-100 ring-4 ring-white/20">
        ...
        <div className="flex flex-col items-center justify-center space-y-10">
            <div className="text-center">
                ...
                <h3 className="text-3xl font-black text-slate-800 font-sans mb-2 tracking-tight">Speak with NEXTGEN ENGLISH</h3>
